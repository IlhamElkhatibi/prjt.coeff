...
app = Flask(__name__)  # Correction de _name_ à __name__
...
def calcul_diffusion(x_A, D_AB0, D_BA0, q_A, q_B, r_A, r_B, a_AB, a_BA, T, D_exp):
    try:
        ...
        # Calcul de theta (paramètre de volume)
        ...
        # Calcul des thêta (θ_AA, θ_BB, θ_AB, θ_BA)
        ...
        # Retourner simplement D_AB, mais définir l'erreur comme étant fixe à 1,6
        error = 1.6
...
# Fonction pour lancer Flask et pywebview simultanément
def start_flask():
...
if __name__ == '__main__':  # Correction de _name_ à __name__
